...
public class ApplianceService {
    ...
    public Appliance convertApplianceDtoToAppliance(ApplianceDto appliance) {
        ...
        Type type=new Type();
        type.setName(appliance.getTypeName());
        ...
        location.setName(appliance.getLocationName());
        ...
        appliance1.setAttributes(attributesList);
         return addApliance(appliance1);
    }




    public ResponseEntity<List<Appliance>> changeStatus(String id) {
                Optional<Appliance> appliance=repository.findById(id);
        if(appliance.isPresent()){
